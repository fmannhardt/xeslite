...
final class PumpContinuousImpl extends XAttributeContinuousExternalImpl {
	
	private static final long serialVersionUID = 1L;
	
	private XAttributeMap attributeMap;

	PumpContinuousImpl(int key, double value, XExtension extension, ExternalStore store, ExternalAttributable owner) {
