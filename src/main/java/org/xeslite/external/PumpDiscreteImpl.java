...
final class PumpDiscreteImpl extends XAttributeDiscreteExternalImpl {
	
	private static final long serialVersionUID = 1L;
	
	private XAttributeMap attributeMap;

	PumpDiscreteImpl(int key, long value, XExtension extension, ExternalStore store, ExternalAttributable owner) {
